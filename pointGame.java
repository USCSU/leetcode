...
public class pointGame {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(k<10){	//测试100次
            ...
            boolean ok=pointGame.compute(number,result,CardsNumber, list);
    ...
    //方法1
    public static boolean compute(double[] number,String[] result,int n, ArrayList<String> list){
        if(n==1){
        ...
        for(int i=0;i<n;i++){
            for(int j=i+1;j<n;j++){
                ...
                number[i] = a+b;
                result[i] = '(' + expa + '+' + expb + ')';
                if(compute(number,result,n-1,list)){
                    return true;
                }
